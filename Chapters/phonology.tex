...
\begin{itemize}
\item Nouns always end in a vowel.
\item Verbs always end in a consonant.
\end{itemize}
...
\begin{definition}[Centralisation]
~\\
u \textrightarrow \textipa{\"u} / \_~\{p, m ,w\}
\end{definition}
...
~\\
i \textrightarrow \textipa{\~i} / \_ \{\textipa{\|]{n}}, \textipa{\textsubsquare{n}}\}

a \textrightarrow \textipa{\~a} / \_ \{\textipa{\|]{n}}, \textipa{\textsubsquare{n}}\}
\end{definition}
...
There are some restrictions placed on consonant clusters. The following combinations are the only allowable clusters:

\begin{itemize}
\item rhotic/liquid + non-retroflex nasal
\item rhotic/liquid + non-rhotic approximant
\item nasal + non-rhotic approximant/stop
\item approximant + stop
\item retroflex + stop
\end{itemize}
...
\begin{definition}[Voicing]
  ...
  p \textrightarrow \textipa{\v*p} / \^{}\_

  \textipa{\|]{t}} \textrightarrow \textipa{\v*t} / \^{}\_\footnote{The phoneme
